...
# This tool is just for educationa testing only if you use this tool  for any illigal action then i am not responsiblr for your action .
...
def banner():
    print(bcolors.GREEN + '+[+[+[ Email Boomber v1.0 ]+]+]+')
